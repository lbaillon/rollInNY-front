    ...
    useEffect(() => {
        (async () => {
            ...
            if (status !== "granted") {
                Alert.alert(
                    "Permission denied",
                    "Access to camera is required to take photos"
                );
            }
        })();
        ...
        try {
            ...
            if (resizedPhoto?.uri) {
                ...
                try {
                    ...
                    console.error(
                        "❌ (Camera Screen): Error in post picture in cloudinary",
                        err
                    );
                    Alert.alert(
                        "Error !",
                        "An internal error occurred while uploading picture."
                    );
                }
            }
        } catch (err) {
            ...
            Alert.alert(
                "Error !",
                "An internal error occurred while taking picture."
            );
        } finally {
